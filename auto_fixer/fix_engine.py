...
if bandit_report.exists():
    ...
    for issue in data.get("results", []):
        ...
        fix = fixes.get(test_id, {}).get("fix", "Review manually")
        report_items.append({
            "type": "Code",
...
# --- Generate full human-readable Markdown report ---
...
print("✅ Scan complete. Check the report for vulnerabilities and suggested fixes.")
